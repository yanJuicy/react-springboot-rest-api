    ...
    <>
      ...
      <form>
        <div className="mb-3">
          ...
          <input type="email" className="form-control mb-1" id="email" value={order.email} onChange={changeEmailInput} />
        </div>
        <div className="mb-3">
          <label htmlFor="address" className="form-label">주소</label>
          <input type="text" className="form-control mb-1" id="address" value={order.address} onChange={changeAddressInput} />
        </div>
        <div className="mb-3">
          <label htmlFor="postcode" className="form-label">우편번호</label>
          <input type="text" className="form-control" id="postcode" value={order.postcode} onChange={changePostcodeInput} />
        </div>
