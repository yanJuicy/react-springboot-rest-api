...
function App() {
  const [products, setProcuts] = useState([
    { productId: 'uuid-1', prodcutName: '콜롬비아 커피1', category: '커피빈', price: 5000 },
    { productId: 'uuid-2', prodcutName: '콜롬비아 커피2', category: '커피빈', price: 5000 },
    { productId: 'uuid-3', prodcutName: '콜롬비아 커피3', category: '커피빈', price: 5000 },
  ]);
  ...
  const handleAddClick = productId => {
    ...
    const udpateItems = 
              found ? items.map(
                    v => (v.productId === productId) ? { ...v, count: v.count + 1 } : v) 
